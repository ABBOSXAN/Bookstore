...
class InstallCommand(RequirementCommand):
    ...
    an easy way to specify a whole .env to be installed.
    """
    ...
    def run(self, options: Values, args: List[str]) -> int:
        ...
        # Check whether the .env we're installing into is externally
...
def decide_user_install(
    ...
    options.
    If use_user_site is None, the default behaviour depends on the .env,
    which is provided by the other arguments.
    """
    # In some cases (bookstore from tox), use_user_site can be set to an integer
