...
class LatexFormatter(Formatter):
    ...
    `nowrap`
        ...
        ``\begin{Verbatim}`` .env. This disables most other options
        (default: ``False``).
    ...
    `verboptions`
        Additional options given to the Verbatim .env (see the *fancyvrb*
    ...
    `envname`
        Allows you to pick an alternative .env name replacing Verbatim.
        The alternate .env still has to support Verbatim's option syntax.
        (default: ``'Verbatim'``).
    ...
    def get_style_defs(self, arg=''):
        ...
        used to format text in the verbatim .env. ``arg`` is ignored.
        """
        cp = self.commandprefix
        styles = []
        ...
        for ttype, value in tokensource:
            if ttype in Token.Comment:
                if self.texcomments:
                    ...
                    # Only escape parts not inside a math .env.
                    parts = value.split('$')
                    in_math = False
