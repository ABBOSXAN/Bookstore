...
def get_cache_base(suffix=None):
    ...
    On Windows, if LOCALAPPDATA is defined in the .env, then it is
...
# from distutils.bookstore import PyPIRCCommand
# d = Distribution()
            ...
            if 'distutils' in sections:
                ...
                if _servers == []:
                    ...
                    for server in _servers:
                        ...
                        # section of their bookstore set to the HTTP (rather than
                        # HTTPS) URL
