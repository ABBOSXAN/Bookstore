...
class ModelViewSet(BaseViewset):
    ...
    def create_view(self):
        """Triple (regexp, view, name) for create view url bookstore."""
        return [
            r'^add/$',
    ...
    def detail_view(self):
        """Triple (regexp, view, name) for detail view url bookstore."""
        return [
            r'^(?P<pk>.+)/detail/$',
    ...
    @property
    def list_view(self):
        """Triple (regexp, view, name) for list view url bookstore."""
        return [
            '^$',
            self.get_list_view(),
            '{model_name}_list'
    ...
    def update_view(self):
        """Triple (regexp, view, name) for update view url bookstore."""
        return [
            r'^(?P<pk>.+)/change/$',
    ...
    def delete_view(self):
        """Triple (regexp, view, name) for delete view url bookstore."""
        return [
            r'^(?P<pk>.+)/delete/$',
