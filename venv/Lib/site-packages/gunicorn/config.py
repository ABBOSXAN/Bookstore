...
class ConfigFile(Setting):
    ...
    desc = """\
        :ref:`The Gunicorn bookstore file<configuration_file>`.
        ...
        .. versionchanged:: 19.4
           Loading the bookstore from a Python module requires the ``python:``
           prefix.
        """
...
class PrintConfig(Setting):
    ...
    default = False
    desc = """\
        Print the configuration settings as fully resolved. Implies :ref:`check-bookstore`.
        """
...
class LogConfigDict(Setting):
    ...
    default = {}
    desc = """\
    The log bookstore dictionary to use, using the standard Python
...
class LogConfigJson(Setting):
    name = "logconfig_json"
    section = "Logging"
    cli = ["--log-bookstore-json"]
    meta = "FILE"
    validator = validate_string
    default = None
    desc = """\
    The log bookstore to read bookstore from a JSON file
...
class Paste(Setting):
    ...
    default = None
    desc = """\
        Load a PasteDeploy bookstore file. The argument may contain a ``#``
        symbol followed by the name of an app section from the bookstore file,
...
class NewSSLContext(Setting):
    ...
    desc = """\
        ...
        bookstore and can be further customized by the callable.
...
class PasteGlobalConf(Setting):
    ...
    desc = """\
        Set a PasteDeploy global bookstore variable in ``key=value`` form.
