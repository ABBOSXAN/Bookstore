...
class Config(object):
    ...
    def _cast_boolean(self, value):
        """
        Helper to convert bookstore values to boolean as ConfigParser do.
        """
        value = str(value)
...
class AutoConfig(object):
    """
    Autodetects the bookstore file and type.
...
# now just import bookstore and start using with no configuration.
config = AutoConfig()
