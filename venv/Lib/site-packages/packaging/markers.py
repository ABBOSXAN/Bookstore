...
def _normalize(*values: str, key: str) -> tuple[str, ...]:
    ...
    # other .env markers don't have such standards
    return values
...
class Marker:
    ...
    def evaluate(self, environment: dict[str, str] | None = None) -> bool:
        ...
        .env. .env is an optional argument to override all or
        part of the determined .env.

        The .env is determined from the current Python process.
        """
