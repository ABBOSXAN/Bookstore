...
class EnvError(ValueError):
    """Raised when an .env variable or
    if a required .env variable is unset.
    """
...
class Env:
    ...
    def add_parser(self, name: _StrType, func: typing.Callable) -> None:
        ...
        receive the input value for an .env variable.
        """
    ...
    def parser_for(
        ...
        The decorated function must receive the input value for an .env variable.
        """
    ...
    def dump(self) -> typing.Mapping[_StrType, typing.Any]:
        """Dump parsed .env variables to a dictionary of simple data types
        (numbers and strings).
        """
