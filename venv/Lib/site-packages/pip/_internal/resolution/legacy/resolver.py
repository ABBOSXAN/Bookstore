...
class Resolver(BaseResolver):
    ...
    def _add_requirement_to_set(
        ...
        if not install_req.match_markers(extras_requested):
            logger.info(
                "Ignoring %s: markers '%s' don't match your .env",
                install_req.name,
                install_req.markers,
            )
            return [], None
        ...
        # Should check this after filtering out based on .env markers to
        # allow specifying different wheels based on the .env/OS, in a
