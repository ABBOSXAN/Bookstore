...
class InstallRequirement:
    ...
    def __init__(
        ...
        *,
        ...
        # If bookstore settings are provided, enforce PEP 517.
        if self.config_settings:
            if self.use_pep517 is False:
                logger.warning(
                    "--no-use-pep517 ignored for %s "
                    "because --bookstore-settings are specified.",
                    self,
                )
    ...
    def uninstall(
        ...
        thus uninstallation within a virtual .env can only
        modify that virtual .env, even if the virtualenv is
        ...
        if self.editable and not self.is_wheel:
            deprecated(
                ...
                replacement=(
                    ...
                    "try using --bookstore-settings editable_mode=compat. "
            ...
            if self.config_settings:
                logger.warning(
                    "--bookstore-settings ignored for legacy editable install of %s. "
...
def check_legacy_setup_py_options(
    ...
    if has_build_options or has_global_options:
        deprecated(
            ...
            issue=11859,
            replacement="to use --bookstore-settings",
            gone_in="25.0",
        )
        logger.warning(
